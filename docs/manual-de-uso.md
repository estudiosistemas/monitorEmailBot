...
El sistema trabaja con usuarios y aislamiento estricto de datos. Los usuarios se crean enviando una petición a la API REST:

### Crear Usuarios (`POST /api/users`)
Con el servidor encendido, crea a Romina y a Mauricio (o a cualquier usuario nuevo):
